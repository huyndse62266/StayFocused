...
class PostGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Post entity")
        ...
        .repeat(2) {
            ...
            .post("/api/posts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "postID":"SAMPLE_TEXT", "postName":"SAMPLE_TEXT", "postDescription":"SAMPLE_TEXT", "postStartDate":"2020-01-01T00:00:00.000Z", "postEndDate":"2020-01-01T00:00:00.000Z", "postBanner":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
