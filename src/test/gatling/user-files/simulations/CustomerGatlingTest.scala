...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "customerID":"SAMPLE_TEXT", "customerPassword":"SAMPLE_TEXT", "customerFullName":"SAMPLE_TEXT", "customerDOB":"2020-01-01T00:00:00.000Z", "customerPhone":"0", "customerAddress":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
