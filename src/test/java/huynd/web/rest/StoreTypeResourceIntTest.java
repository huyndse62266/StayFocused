...
public class StoreTypeResourceIntTest {
    ...
    private static final String DEFAULT_STORE_TYPE_ID = "AAAAAAAAAA";
    private static final String UPDATED_STORE_TYPE_ID = "BBBBBBBBBB";

    private static final String DEFAULT_STORE_TYPE_NAME = "AAAAAAAAAA";
    private static final String UPDATED_STORE_TYPE_NAME = "BBBBBBBBBB";
    ...
    public static StoreType createEntity(EntityManager em) {
        StoreType storeType = new StoreType()
            .storeTypeID(DEFAULT_STORE_TYPE_ID)
            .storeTypeName(DEFAULT_STORE_TYPE_NAME);
        return storeType;
    }
    ...
    public void createStoreType() throws Exception {
        ...
        assertThat(testStoreType.getStoreTypeID()).isEqualTo(DEFAULT_STORE_TYPE_ID);
        assertThat(testStoreType.getStoreTypeName()).isEqualTo(DEFAULT_STORE_TYPE_NAME);
    }
    ...
    public void getAllStoreTypes() throws Exception {
        ...
        restStoreTypeMockMvc.perform(get("/api/store-types?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].storeTypeID").value(hasItem(DEFAULT_STORE_TYPE_ID.toString())))
            .andExpect(jsonPath("$.[*].storeTypeName").value(hasItem(DEFAULT_STORE_TYPE_NAME.toString())));
    }
    ...
    public void getStoreType() throws Exception {
        ...
        restStoreTypeMockMvc.perform(get("/api/store-types/{id}", storeType.getId()))
            ...
            .andExpect(jsonPath("$.storeTypeID").value(DEFAULT_STORE_TYPE_ID.toString()))
            .andExpect(jsonPath("$.storeTypeName").value(DEFAULT_STORE_TYPE_NAME.toString()));
    }
    ...
    public void updateStoreType() throws Exception {
        ...
        updatedStoreType
            .storeTypeID(UPDATED_STORE_TYPE_ID)
            .storeTypeName(UPDATED_STORE_TYPE_NAME);
        ...
        StoreType testStoreType = storeTypeList.get(storeTypeList.size() - 1);
        assertThat(testStoreType.getStoreTypeID()).isEqualTo(UPDATED_STORE_TYPE_ID);
        assertThat(testStoreType.getStoreTypeName()).isEqualTo(UPDATED_STORE_TYPE_NAME);
    }
