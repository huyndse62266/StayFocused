...
import huynd.service.dto.PasswordChangeDTO;
import huynd.web.rest.errors.ExceptionTranslator;
import huynd.web.rest.vm.KeyAndPasswordVM;
import huynd.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        duplicatedUser.setUsername(validUser.getUsername());
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        ManagedUserVM duplicatedUser = new ManagedUserVM();
        duplicatedUser.setUsername("johnjr");
        duplicatedUser.setPassword(validUser.getPassword());
        duplicatedUser.setFirstName(validUser.getFirstName());
        duplicatedUser.setLastName(validUser.getLastName());
        ...
        userWithUpperCaseEmail.setUsername("johnjr");
