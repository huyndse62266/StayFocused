  ...
  describe('Voucher Service', () => {
    ...
    describe('Service methods', () => {
      it('should call correct URL', () => {
        ...
        const resourceUrl = SERVER_API_URL + 'api/vouchers';
        expect(req.request.url).toEqual(resourceUrl + '/' + 123);
      });

      it('should create a Voucher', () => {
        service.create(new Voucher(null)).subscribe(received => {
      ...
      it('should update a Voucher', () => {
        service.update(new Voucher(123)).subscribe(received => {
